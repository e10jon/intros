...
CREATE TABLE "User" (
    ...
    "nextEmailSendAt" TIMESTAMP(3),
    "nextIntrosResetAt" TIMESTAMP(3),
...
-- CreateIndex
CREATE INDEX "User_nextEmailSendAt_idx" ON "User"("nextEmailSendAt");

-- CreateIndex
CREATE INDEX "User_nextIntrosResetAt_idx" ON "User"("nextIntrosResetAt");
